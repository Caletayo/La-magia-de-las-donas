  ...
  run: (client, interaction, message, isSlash, args, manager) => {
    ...
    if (!memberVoiceChannel)
      return respond(
        ...
        message,
        {
          content: "<:uo_music:981601443712737310> You must join a voice channel to use that!",
        },
        isSlash
      );
    if (botVoiceChannel && botVoiceChannel.id !== memberVoiceChannel.id)
      return respond(
        ...
        message,
        {
          content: `<:uo_music:981601443712737310> You must be listening in **${botVoiceChannel.name}** to use that!`,
        },
        isSlash
      );
    if (!songName)
      return respond(
        ...
        message,
        {
          content: "<:uo_music:981601443712737310> Please include a query.",
        },
        isSlash
      );
    respond(
      ...
      message,
      {
        content: `<:uo_music:981601635027533825> Searching ... (\`${songName}\`)`,
      },
      isSlash
    ).then(async (m) => {
      try {
...
async function playMusic(index, player, m, res, interaction, isSlash) {
  ...
  editRespond(
    ...
    m,
    {
      content: `<:uo_music:981601443712737310> **${
