  ...
  run: async (client, interaction, message, isSlash, args, manager) => {
    ...
    if (!memberVoiceChannel)
      return respond(
        ...
        message,
        {
          content: "<:uo_music:981603075326365746> You must join a voice channel to use that!",
        },
        isSlash
      );
    if (botVoiceChannel && botVoiceChannel.id !== memberVoiceChannel.id)
      return respond(
        ...
        message,
        {
          content: `<:uo_music:981603075326365746> You must be listening in **${botVoiceChannel.name}** to use that!`,
        },
        isSlash
      );
    ...
    if (!player || !player.queue.current)
      return respond(
        ...
        message,
        {
          content: "<:uo_music:981603075326365746> There must be music playing to use that!",
        },
        isSlash
      );
    ...
    respond(
      ...
      message,
      {
        content: `<:uo_music:981603075326365746> Repeat Mode: **${
