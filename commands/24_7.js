  ...
  run: async (client, interaction, message, isSlash, args, manager, db) => {
    ...
    if (!memberVoiceChannel)
      return respond(
        ...
        message,
        {
          content: "<:uo_music:981588034946486362> You must join a voice channel to use that!",
        },
        isSlash
      );
    if (
      ...
      respond(
        ...
        message,
        {
          content: `<:uo_music:981588034946486362> bot i'll leave this channel when you use \`/stop\` command.`,
        },
        isSlash
      );
    } else {
      ...
      respond(
        ...
        message,
        {
          content: `<:uo_music:981588034946486362> bot i'll never leave this channel.`,
        },
        isSlash
      );
    }
