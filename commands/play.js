  ...
  run: (client, interaction, message, isSlash, args, manager) => {
    ...
    if (!memberVoiceChannel)
      return respond(
        ...
        message,
        {
          content: "<a:a2_music:983743143340032010> You must join a voice channel to use that!",
        },
        isSlash
      );
    if (botVoiceChannel && botVoiceChannel.id !== memberVoiceChannel.id)
      return respond(
        ...
        message,
        {
          content: `<a:a2_music:983743143340032010> You must be listening in **${botVoiceChannel.name}** to use that!`,
        },
        isSlash
      );
    if (
      ...
      respond(
        ...
        message,
        {
          content: `<a:a2_music:983743143340032010> Resumed **${
            manager.players.get(
              isSlash == true ? interaction.guildId : message.guildId
            )?.queue?.current?.title
          }**`,
          ...
          embeds: [
            {
              ...
              fields: [
                ...
                {
                  name: "**Examples:**",
                  value: `${config.prefix}play Havana\n${config.prefix}play https://www.youtube.com/watch?v=example`,
                },
              ],
            },
          ],
    ...
    respond(
      ...
      message,
      {
        content: `<:uo_music:981600957760700446> Searching ... (\`${songName}\`)`,
      },
      isSlash
    ).then(async (m) => {
      try {
