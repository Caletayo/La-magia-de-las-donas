  ...
  run: (client, interaction, message, isSlash, args, manager) => {
    ...
    if (!memberVoiceChannel)
      return respond(
        ...
        message,
        {
          content: "<:uo_music:981587694075404398> You must join a voice channel to use that!",
        },
        isSlash
      );
    if (botVoiceChannel && botVoiceChannel.id !== memberVoiceChannel.id)
      return respond(
        ...
        message,
        {
          content: `<:uo_music:981587694075404398> You must be listening in **${botVoiceChannel.name}** to use that!`,
        },
        isSlash
      );
    ...
    if (!player || !player.queue.current)
      return respond(
        ...
        message,
        {
          content: "**<:uo_music:981603075326365746> No music playing.**",
          embeds: [
            {
              title: "**<:uo_music:981587694075404398> Current Queue | 0 entries**",
            },
          ],
        },
        isSlash
    ...
    respond(
      ...
      message,
      {
        content: `**<:uo_music:981603075326365746> ${player.queue.current.title}**`,
        embeds: [
          {
            title: "**<:uo_music:981603075326365746> Current Queue | 0 entries**",
